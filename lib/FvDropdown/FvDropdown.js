...
class Dropdown {
    ...
    createEvent(eventOptions = { bubbles: false, cancelable: true, cancelBubble: true }) {

        const [openEvent, closeEvent] = [
            new Event(this.EVENT_LIST[0], eventOptions),
            new Event(this.EVENT_LIST[1], eventOptions)
        ];
